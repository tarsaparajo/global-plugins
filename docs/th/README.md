...
### Claude Code (เนทีฟ — เป้าหมายหลัก)
...
> คำสั่ง `/plugin` ด้านบนใช้ได้กับ Claude Code เท่านั้น ผู้ให้บริการรายอื่นทุกรายติดตั้งด้วยการคัดลอกโฟลเดอร์ dotfolder ที่ถูก commit ไว้ไปยังตำแหน่งที่ต้องการ

### ผู้ให้บริการรายอื่น

โฟลเดอร์ dotfolder ของผู้ให้บริการแต่ละรายคือ artifact จริงที่พร้อมใช้งาน ถูกสร้างใหม่ด้วยการฉายภาพซ้ำ อย่าแก้ไขด้วยมือเด็ดขาด ผู้ให้บริการแบบ *home* (CLI) จะติดตั้งลงในไดเรกทอรี home ของคุณ ส่วนผู้ให้บริการแบบ *project* (IDE/editor) จะติดตั้งลงในรากของ repository คัดลอกโฟลเดอร์ dotfolder ที่ตรงกัน

| ผู้ให้บริการ | ขอบเขต | คัดลอกไปยัง |
|----------|-------|---------|
| codex | home | `~/.codex` |
| qwen | home | `~/.qwen` |
| opencode | home | `~/.opencode` — รัน `node engine/build-opencode.js` ก่อน |
