...
ติดตั้งได้จาก plugin marketplace หรือติดตั้งด้วยตนเองโดยคัดลอกไดเรกทอรีนี้ไปยังตำแหน่งปลั๊กอินของคุณ โฟลเดอร์ dotfolder ของผู้ให้บริการที่ถูก commit ไว้คือ artifact จริงที่ถูกสร้างใหม่ด้วยการฉายภาพซ้ำ อย่าแก้ไขด้วยมือเด็ดขาด
...
ปลั๊กอินที่สร้างขึ้นจะมาพร้อมกับ `/<plugin>:evolve` และ `/<plugin>:migrate` เพิ่มเติมสำหรับการวิวัฒน์ตัวเอง
