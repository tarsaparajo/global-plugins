...
// prefix marks it as infrastructure (the same convention as the inner `_engine`)
// and groups every plugin's bundle together. Falsy slug -> '' (legacy flat
// layout, used only by fixtures with no manifest).
