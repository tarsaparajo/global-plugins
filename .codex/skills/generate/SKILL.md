...
- `skills/_knowledge/readme-skeleton.md` — the README skeleton standard (centered block, hero in every locale, badges, dual switcher, per-provider install + rules box, hero SVG→PNG with a per-plugin palette).
