...
- Non-standard infrastructure is grouped under the plugin's private `_<slug>/` bundle; standard/shared capability and discovery surfaces never move there (per `_global-plugins/knowledge/namespacing.md`).
