...
- Non-standard infrastructure is grouped under the plugin's private `_<slug>/` bundle; standard/shared capability and discovery surfaces never move there (per `skills/_knowledge/namespacing.md`).
