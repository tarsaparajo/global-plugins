...
- `skills/_knowledge/hero-skeleton.md` — the hero skeleton standard: the shared neutral SVG model authored per plugin (palette + logo), and the zero-dependency SVG→PNG conversion an adapted plugin's hero follows.
